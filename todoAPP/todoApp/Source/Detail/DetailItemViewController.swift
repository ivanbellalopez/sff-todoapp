...
final class DetailItemViewController: UIViewController {
    ...
    private let presenter: DetailItemPresenterInterface

    // MARK: - Init

    init(presenter: DetailItemPresenterInterface) {
    ...
    private func setupViews() {
        ...
        updateButton.addTarget(self, action: #selector(didUpdateButtonTapped), for: .touchUpInside)
...
extension DetailItemViewController: DetailItemViewInterface {
...
private extension DetailItemViewController {
    ...
    @objc func didUpdateButtonTapped() {
        ...
        presenter.didUpdateButtonTapped(name: name, description: description)
    }
}
